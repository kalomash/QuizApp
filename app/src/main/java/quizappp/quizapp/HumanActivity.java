...
public class HumanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        score = (Button)findViewById(R.id.human_score_button);

        G1 = (RadioGroup) findViewById(R.id.human_quest1_group);
        Q1A3=(RadioButton)findViewById(R.id.human_quest1_radio3);
        Q1A2=(RadioButton)findViewById(R.id.human_quest1_radio2);
        Q1A4=(RadioButton)findViewById(R.id.human_quest1_radio4);
        Q1A1=(RadioButton)findViewById(R.id.human_quest1_radio1);

        G2 = (RadioGroup) findViewById(R.id.human_quest2_group);
        Q2A3=(RadioButton)findViewById(R.id.human_quest2_radio3);
        Q2A2=(RadioButton)findViewById(R.id.human_quest2_radio2);
        Q2A4=(RadioButton)findViewById(R.id.human_quest2_radio4);
        Q2A1=(RadioButton)findViewById(R.id.human_quest2_radio1);

        G3 = (RadioGroup) findViewById(R.id.human_quest3_group);
        Q3A3=(RadioButton)findViewById(R.id.human_quest3_radio3);
        Q3A2=(RadioButton)findViewById(R.id.human_quest3_radio2);
        Q3A4=(RadioButton)findViewById(R.id.human_quest3_radio4);
        Q3A1=(RadioButton)findViewById(R.id.human_quest3_radio1);

        G4 = (RadioGroup) findViewById(R.id.human_quest4_group);
        Q4A3=(RadioButton)findViewById(R.id.human_quest4_radio3);
        Q4A2=(RadioButton)findViewById(R.id.human_quest4_radio2);
        Q4A4=(RadioButton)findViewById(R.id.human_quest4_radio4);
        Q4A1=(RadioButton)findViewById(R.id.human_quest4_radio1);

        G5 = (RadioGroup) findViewById(R.id.human_quest5_group);
        Q5A3=(RadioButton)findViewById(R.id.human_quest5_radio3);
        Q5A2=(RadioButton)findViewById(R.id.human_quest5_radio2);
        Q5A4=(RadioButton)findViewById(R.id.human_quest5_radio4);
        Q5A1=(RadioButton)findViewById(R.id.human_quest5_radio1);
        ...
        score.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // set title
                alertDialogBuilder.setTitle("Humans Quiz");
